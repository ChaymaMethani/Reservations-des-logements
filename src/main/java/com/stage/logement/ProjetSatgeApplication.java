...
public class ProjetSatgeApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProjetSatgeApplication.class, args);
		System.out.println("le projet de stage ");
	}
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(Collections.singletonList("http://localhost:4200")); // le port d'accés 
